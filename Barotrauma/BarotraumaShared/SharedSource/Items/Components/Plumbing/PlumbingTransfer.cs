...
{
    class PlumbingTransfer : Plumbed
    {
        ...
        private static readonly HashSet<PlumbingTransfer> recipientsToRefresh = new HashSet<PlumbingTransfer>();
            ...
            if (!isBroken)
            {
                ...
                foreach (HashSet<Connection> recipientList in connectedRecipients.Values)
                {
                    foreach (Connection c in recipientList)
                    {
                        ...
                        var recipientPowerTransfer = c.Item.GetComponent<PlumbingTransfer>();
                ...
                foreach (PlumbingTransfer recipientPowerTransfer in recipientsToRefresh)
                {
        ...
        protected void RefreshConnections()
        {
            ...
            foreach (Connection c in connections)
            {
                ...
                else
                {
                    ...
                    {
                        var pt = recipient.Item.GetComponent<PlumbingTransfer>();
                ...
                if (item.Condition > 0.0f)
                {
                    ...
                    foreach (Connection recipient in tempConnected)
                    {
                        ...
                        var recipientPowerTransfer = recipient.Item.GetComponent<PlumbingTransfer>();
