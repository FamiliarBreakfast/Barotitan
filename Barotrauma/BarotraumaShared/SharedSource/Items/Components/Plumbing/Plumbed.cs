...
namespace Barotrauma.Items.Components
{
    ...
    readonly struct PlumbingRange
    {
        public readonly static PlumbingRange Zero = default;
        ...
        public PlumbingRange(float min, float max) : this(min, max, 0.0f)
        {
        }

        public PlumbingRange(float min, float max, float reactorMaxOutput)
        {
        ...
        public static PlumbingRange operator +(PlumbingRange a, PlumbingRange b)
        {
            return new PlumbingRange(a.Min + b.Min, a.Max + b.Max, a.ReactorMaxOutput + b.ReactorMaxOutput);
        }
        public static PlumbingRange operator -(PlumbingRange a, PlumbingRange b)
        {
            return new PlumbingRange(a.Min - b.Min, a.Max - b.Max, a.ReactorMaxOutput - b.ReactorMaxOutput);
    ...
    partial class Plumbed : ItemComponent
    {
        ...
        public Plumbed(Item item, ContentXElement element)
            : base(item, element)
        {
